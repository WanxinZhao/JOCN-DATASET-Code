...
class ExecutionAgent:
    def __init__(
        ...
        raw_topology_path = Path(topology_path)
        raw_equipment_path = Path(equipment_path)
        self._topology_path = (
            raw_topology_path if raw_topology_path.is_absolute() else self._root / raw_topology_path
        )
        self._equipment_path = (
            raw_equipment_path if raw_equipment_path.is_absolute() else self._root / raw_equipment_path
        )
